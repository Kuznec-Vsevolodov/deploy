...
from .views import PlaceForOwnersListView, PlaceDetailView, SectorDetailView, SectorListView, Parking_placeDetailView, BookingListView, ParkingPlaceListView, WalletDetailView, RegisterView, EventListView, EventDetailView, PlacesListView, SectorsByPlaceView, PlaceRedoDetailView, ParkingPlaceBySectorView, GetUserData, BookingPlacesByUserView
...
urlpatterns = [
    ...
    path('get-data/', GetUserData.as_view()),
    path('get-users-places/<int:pk>', BookingPlacesByUserView.as_view())
]